    ...
    <div className="">
      ...
      <div className="flex flex-wrap justify-center mt-[-50px]">
        {chooseCipher.map((chooseCipher, index) => (
          ...
          >
            <div className="[background:radial-gradient(125%_125%_at_50%_10%,#0072D8_20%,#000_70%)] rounded-2xl p-6 text-md border border-neutral-800 font-thin lg:h-[310px] lg:w-[300px] space-y-2">
