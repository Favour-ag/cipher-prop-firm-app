  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="lg:px-7">
        <p className="text-center lg:text-5xl py-16 font-semibold">
          Let’s begin with Cipher Challenge
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:space-x-6">
          <div className="">
            ...
            <div className="w-full flex flex-col pt-6  bg-blue-400">
          ...
          <div className=" flex flex-col items-center lg:gap-8 bg-purple-400">
            ...
            <div className="border rounded-2xl md:w-[540px] h-[430px] md:h-[510px] text-sm md:text-base">
              <div className="flex flex-col py-4 md:py-8 px-3 md:px-8">
                <p className="text-lg md:text-center">Choose Payment Method</p>
                <div className="mt-5">
                  <p>
