      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <p>
              The maximum daily loss is 3% on stage 1 and also when you become a
              cipher trader.
            </p>
          </div>
          <div>
            ...
            <p>
              The overall maximum loss is 8% on stage 1 and also when you become
              a cipher trader.
            </p>
          </div>
          <div>
            ...
            <p>
              To not violate or breach your account via losses. Don’t loose more
              than your daily loss per day which is 3% and don’t loose more than
              8% overall of the initial balance.
            </p>
          </div>
          <div>
        ...
        <div>
          ...
          <div>
            <p>What is the overall maximum loss?</p>
            <p>
              The overall maximum loss is 10% on stage 1 and stage 2. This also
              continues when you become a cipher trader.
            </p>
          </div>
          <div>
            ...
            <p>
              To not violate or breach your account via losses. Don’t loose more
              than your daily loss per day which is 5% and don’t loose more than
              10% overall of the initial balance.
            </p>
          </div>
          <div>
            <p>Can you hold trades overnights and the weekend?</p>
          ...
          <div>
            <p>What is the profit target?</p>
            <p>
              The profit target of 2Step is 7% on stage one and 5% on stage two.
            </p>
          </div>
          <div>
            <p>What is the daily maximum limit reset time?</p>
